...
export function AssessmentResult() {
 ...
 <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">Generating Manifest...</p>
 </div>
 </div>
 );
 }
 ...
 <h1 className="text-4xl font-bold tracking-tight text-slate-900 uppercase">Assessment Report.</h1>
 <p className="text-slate-500 font-bold text-sm mt-2 uppercase tracking-wider">{assessment?.title || 'Protocol Execution Result'}</p>
 </div>
 <div className="flex gap-4">
 <div className="px-5 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-500 uppercase tracking-wider shadow-sm flex items-center gap-2">
 ...
 <p className={`text-xs font-bold uppercase tracking-wider ${isPassed ? 'text-indigo-200' : 'text-slate-400'}`}>
 ...
 <h4 className={`text-xs font-bold uppercase tracking-wider mb-1 ${isPassed ? 'text-indigo-200' : 'text-slate-400'}`}>INTEGRITY GRADE</h4>
 <p className="text-2xl font-bold">{integrityGrade}</p>
 {isPassed && <p className="text-xs font-bold mt-2 tracking-wider uppercase">VERIFIED PARTNER</p>}
 </div>
 </div>
 ...
 <div className={`px-2 py-1 rounded-md text-xs font-bold uppercase tracking-wider ${v.severity === 'critical' ? 'bg-rose-100 text-rose-700' : 'bg-slate-200 text-slate-600'}`}>
 {v.severity}
 </div>
 <span className="text-xs font-bold text-slate-700">{v.message}</span>
 </div>
 <span className="text-xs font-medium text-slate-400">{new Date(v.timestamp).toLocaleTimeString()}</span>
 </div>
 ))}
 </div>
 ) : (
 ...
 <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">Pristine Session Flow</p>
 </div>
 )}
 </motion.div>
 </div>
 ...
 <span className="text-lg font-bold uppercase tracking-tight">Verified Badge Earned</span>
 </div>
 <p className="text-xs font-bold uppercase tracking-wider text-emerald-600/60 bg-emerald-100/50 px-4 py-1 rounded-full border border-emerald-200">
 ...
 <div className="space-y-6">
 <div>
 <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 block">Your Assessment Experience</label>
 <textarea 
