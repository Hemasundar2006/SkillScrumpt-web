...
const UpgradeModal = ({ onClose }) => {
 ...
 <div className="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-4 flex items-center justify-center gap-2">
 ...
 <div className="inline-block px-4 py-2 bg-indigo-50 text-indigo-700 text-xs font-bold uppercase tracking-wider mb-6 rounded-full">
...
function TalentCard({ id, name, role, rating, skills, score, avatar, isPro, delay }) {
 ...
 >
 {isPro && (
 <div className="absolute top-6 right-6 flex items-center gap-1 px-3 py-1 bg-indigo-50 text-indigo-600 text-xs font-bold rounded-full">
 <Zap size={12} fill="currentColor" /> PRO
 </div>
 )}
 ...
 <p className="text-xs text-slate-500 font-bold uppercase mb-1">AI Match Score</p>
 <p className="text-2xl font-bold text-slate-900">{score}<span className="text-sm text-slate-400">/100</span></p>
 </div>
 <div className="p-4 bg-slate-50 rounded-[1.25rem] border border-slate-100">
 <p className="text-xs text-slate-500 font-bold uppercase mb-1">Client Rating</p>
