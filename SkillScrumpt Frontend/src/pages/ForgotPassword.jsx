...
export default function ForgotPassword() {
 ...
 <Link to="/login" className="flex items-center gap-2 text-slate-400 hover:text-indigo-600 mb-8 transition-colors text-xs font-bold uppercase tracking-wider">
 ...
 <Link to="/login" className="text-indigo-600 font-bold text-sm hover:underline">Return to login interface</Link>
 </motion.div>
 ) : (
 <form onSubmit={handleSubmit} className="space-y-6">
 <div className="space-y-2">
 <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block ml-1">Work Email</label>
 ...
 className="w-full bg-slate-50 border border-slate-200 py-4 pl-14 pr-6 rounded-2xl text-sm font-medium text-slate-900 focus:outline-none focus:border-indigo-500 transition-all placeholder:text-slate-400"
 value={email}
